...
@section('content')
    <div class="container">
        <div class="card hiverable mt-17 p-3 hoverable">
            <h2 class="center-align">Buscar requerimiento</h2>
            <div class="row">
                <form action={{ route('requerimientos.show') }} method="GET" class="col s12">
                    @csrf
                    <div class="row">
                        <div class="input-field col s12">
                            <input type="number" class="validate" name="IDREQ" required>
                            <label for="IDREQ">Código requerimiento *</label>
                            @error('IDREQ')
